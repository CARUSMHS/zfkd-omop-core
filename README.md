...
2. Specify the path to the patient information files (csv format) in config.json. The following tables are required: patient.csv, tumor.csv, op.csv, systemtherapie.csv, strahlentherapie.csv, and fe.csv. Columns in these tables need to be comma-separated.
