...
CREATE TABLE cdm.person (
			...
			person_source_value varchar(150) NULL, -- can be very long in case of doubt, therefore extend the string length here by 100
...
--HINT DISTRIBUTE ON KEY (person_id)
DROP TABLE IF EXISTS cdm.specimen;
...
--HINT DISTRIBUTE ON KEY (person_id)
DROP TABLE IF EXISTS cdm.episode;
...
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.episode_event;
...
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.cdm_source;
...
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.concept CASCADE;
...
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.vocabulary;
...
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.domain;
CREATE TABLE cdm.domain (
			domain_id varchar(20) NOT NULL,
			domain_name varchar(255) NOT NULL,
			domain_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.concept_class;
CREATE TABLE cdm.concept_class (
			concept_class_id varchar(20) NOT NULL,
			concept_class_name varchar(255) NOT NULL,
			concept_class_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.concept_relationship;
CREATE TABLE cdm.concept_relationship (
			...
			invalid_reason varchar(1) NULL );
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.relationship;
CREATE TABLE cdm.relationship (
			...
			relationship_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.concept_synonym;
CREATE TABLE cdm.concept_synonym (
			concept_id integer NOT NULL,
			concept_synonym_name varchar(1000) NOT NULL,
			language_concept_id integer NOT NULL );
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.concept_ancestor;
...
CREATE TABLE cdm.source_to_concept_map (
			...
			invalid_reason varchar(1) NULL );
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.drug_strength;
...
--HINT DISTRIBUTE ON RANDOM
DROP TABLE IF EXISTS cdm.cohort_definition;
